...
class DBAdapter {
    private val dbName = "dbBuku"
    private val dbTable = "Buku"
    private val colId = "Id"
    private val colJudul = "Judul"
    private val colPengarang = "Pengarang"
    private val colHarga = "Harga"
    private val colJumlah = "Jumlah"
    private val dbVersion = 1

    private val CREATE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " +
            dbTable + " (" + colId + " " + "INTEGER PRIMARY KEY," + colJudul + " TEXT, " +
            colPengarang + " TEXT, " + colHarga + " TEXT,  " + colJumlah + " TEXT);"
